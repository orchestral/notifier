...
[![Build Status](https://travis-ci.org/orchestral/notifier.svg?branch=5.x)](https://travis-ci.org/orchestral/notifier)
...
[![Coverage Status](https://coveralls.io/repos/github/orchestral/notifier/badge.svg?branch=5.x)](https://coveralls.io/github/orchestral/notifier?branch=5.x)
